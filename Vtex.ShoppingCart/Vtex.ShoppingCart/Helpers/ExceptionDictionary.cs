using Betsson.Wallet.Service.Exceptions;
using System;
...
namespace Vtex.ShoppingCart.Helpers
{
    public static class ExceptionDictionary
    {
        ...
        private static Dictionary<Type, HttpStatusCode> GetExceptionDictionary()
        {
            ...
            dict[typeof(UnauthorizedAccessException)] = HttpStatusCode.Unauthorized;
            dict[typeof(ValidationException)] = HttpStatusCode.BadRequest;
